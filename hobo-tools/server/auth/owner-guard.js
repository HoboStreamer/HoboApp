...
// ═══════════════════════════════════════════════════════════════
// Owner guard + secret-key detection for hobo.tools.
//
// Owner = the configured Hobo Network owner account (OWNER_USERNAME,
...
// the same definition (mirrors HoboStreamer's server/auth/permissions.js).
// ═══════════════════════════════════════════════════════════════
