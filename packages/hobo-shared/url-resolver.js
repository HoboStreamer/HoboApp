...
const URL_DEFINITIONS = Object.freeze({
    ...
    WEBRTC_PUBLIC_URL: {
        ...
        type: 'origin',
        default: 'http://localhost:3000',
        description: 'Public origin used for WebRTC-facing endpoint discovery and browser consumers.',
    },
    WHIP_PUBLIC_URL: {
        key: 'WHIP_PUBLIC_URL',
    ...
    RTMP_HOST: {
        ...
        type: 'hostname',
        default: '',
        description: 'Host used for RTMP ingest. Do not include protocol or path.',
    },
    JSMPEG_PUBLIC_URL: {
        ...
        type: 'origin',
        default: 'http://localhost:3000',
        description: 'Public origin used to construct JSMPEG relay endpoints for browser and FFmpeg clients.',
    },
    TURN_URL: {
        key: 'TURN_URL',
        label: 'TURN URL',
        ...
        type: 'turn_url',
        default: '',
        description: 'TURN server URL used for WebRTC NAT traversal.',
    },
    HOBO_TOOLS_URL: {
        key: 'HOBO_TOOLS_URL',
...
function resolveRegistryValues(env = {}, overrides = {}, definitions = URL_DEFINITIONS) {
    const resolved = {};
